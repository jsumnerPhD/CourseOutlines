...
On a regular basis, students will be asked to complete small assignments in class which will be marked for the in-class assignment marks. These small assignments can only be completed in class so attendance is important. The topic and nature of the assignment will be announced ahead of time but the assignment itself must be completed in class.  
\smallskip
